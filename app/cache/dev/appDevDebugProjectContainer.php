...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'form.type.calandar' => 'getForm_Type_CalandarService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/jaskamal/public_html/agile-training/path/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('/home/jaskamal/public_html/agile-training/path/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/home/jaskamal/public_html/agile-training/path/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/home/jaskamal/public_html/agile-training/path/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'agiletraining', 'user' => 'root', 'password' => 'jaskamal', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_a010633371c4eaf0293c48cd3926bcf12a2352a053c87651d372a48d06e5ebb6');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_a010633371c4eaf0293c48cd3926bcf12a2352a053c87651d372a48d06e5ebb6');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_a010633371c4eaf0293c48cd3926bcf12a2352a053c87651d372a48d06e5ebb6');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array('/home/jaskamal/public_html/agile-training/path/src/Agile/TrainingBundle/Resources/config/doctrine' => 'Agile\\TrainingBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'Agile\\TrainingBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('AgileTrainingBundle' => 'Agile\\TrainingBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('/home/jaskamal/public_html/agile-training/path/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/home/jaskamal/public_html/agile-training/path/app/Resources');
    }
    ...
    /**
     * Gets the 'form.type.calandar' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Agile\TrainingBundle\Form\Type\CalandarType A Agile\TrainingBundle\Form\Type\CalandarType instance.
     */
    protected function getForm_Type_CalandarService()
    {
        return $this->services['form.type.calandar'] = new \Agile\TrainingBundle\Form\Type\CalandarType();
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/home/jaskamal/public_html/agile-training/path/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/home/jaskamal/public_html/agile-training/path/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/home/jaskamal/public_html/agile-training/path/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/home/jaskamal/public_html/agile-training/path/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true, 'resource_type' => 'yaml'), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/jaskamal/public_html/agile-training/path/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/home/jaskamal/public_html/agile-training/path/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/jaskamal/public_html/agile-training/path/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/home/jaskamal/public_html/agile-training/path/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/home/jaskamal/public_html/agile-training/path/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/home/jaskamal/public_html/agile-training/path/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/home/jaskamal/public_html/agile-training/path/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/jaskamal/public_html/agile-training/path/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/home/jaskamal/public_html/agile-training/path/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/home/jaskamal/public_html/agile-training/path/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/home/jaskamal/public_html/agile-training/path/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/home/jaskamal/public_html/agile-training/path/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/home/jaskamal/public_html/agile-training/path/src/Agile/TrainingBundle/Resources/views', 'AgileTraining');
        $instance->addPath('/home/jaskamal/public_html/agile-training/path/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/home/jaskamal/public_html/agile-training/path/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/home/jaskamal/public_html/agile-training/path/app/Resources/views');
        $instance->addPath('/home/jaskamal/public_html/agile-training/path/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/home/jaskamal/public_html/agile-training/path/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/jaskamal/public_html/agile-training/path/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/home/jaskamal/public_html/agile-training/path/app/cache/dev/assetic/assets');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('544150b28cde9')), true);
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/jaskamal/public_html/agile-training/path/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/home/jaskamal/public_html/agile-training/path/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/jaskamal/public_html/agile-training/path/app/cache/dev',
            'kernel.logs_dir' => '/home/jaskamal/public_html/agile-training/path/app/logs',
            'kernel.bundles' => array(
                ...
                'AgileTrainingBundle' => 'Agile\\TrainingBundle\\AgileTrainingBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'agiletraining',
            'database_user' => 'root',
            'database_password' => 'jaskamal',
            ...
            'debug.container.dump' => '/home/jaskamal/public_html/agile-training/path/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/home/jaskamal/public_html/agile-training/path/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/home/jaskamal/public_html/agile-training/path/app/cache/dev/profiler',
            ...
            'router.resource' => '/home/jaskamal/public_html/agile-training/path/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/jaskamal/public_html/agile-training/path/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/home/jaskamal/public_html/agile-training/path/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/home/jaskamal/public_html/agile-training/path/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/home/jaskamal/public_html/agile-training/path/app/../web',
            'assetic.write_to' => '/home/jaskamal/public_html/agile-training/path/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/home/jaskamal/public_html/agile-training/path/app/cache/dev/doctrine/orm/Proxies',
